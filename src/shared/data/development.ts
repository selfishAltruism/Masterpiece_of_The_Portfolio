export const developmentLogs: Data.Development[] = [
  ...
  },
  {
    ...
    linkedTo: "activity",
    linkedId: 0,
    title: "운동 카운팅 알고리즘 개발",
    description:
      "유닛 테스트 환경 구축 및 데이터 시각화를 통해 압력 센서값 기반 운동 카운팅 알고리즘 개발",
    period: "2024.12 ~ 2025.03",
    tags: ["Unit Test", "Data Visualization", "Integration-based Algorithm"],
  ...
  },
  {
    ...
    linkedTo: "activity",
    linkedId: 2,
    title: "Next.js 및 인증/인가 환경 구축",
    description:
      "Next.js 기반 SSR/CSR 개발환경 구축 및 Refrash Token 기반 인증/인가 시스템 구현",
  ...
  },
  {
    ...
    linkedTo: "activity",
    linkedId: 2,
    title: "서비스 및 팀 홍보 웹 페이지 구현",
    description: "SEO 최적화 기반 서비스 및 팀 홍보 웹 페이지 구현",
