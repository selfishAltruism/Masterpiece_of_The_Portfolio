  ...
  return (
    ...
    >
      <div className="w-full">
        <h3 className="theme-text-primary mb-4 text-xl leading-tight max-md:mb-1 max-md:text-[16px] max-sm:mb-0 lg:w-[calc(100%+130px)]">
          {service.name}
        </h3>
        ...
        {/* mobile mode. */}
        <p className="theme-text-muted mb-2 text-[10px] leading-tight sm:hidden">
          개인 개발
        </p>
