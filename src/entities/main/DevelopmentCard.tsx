...
export const DevelopmentCard = ({
  ...
  return (
    <div
      ...
      className="mb-2 mt-2 flex items-end justify-between rounded-lg border border-white bg-white/10 p-5 text-white max-lg:flex-col max-lg:gap-5 max-md:gap-2 max-sm:gap-1 max-sm:p-2 max-sm:pt-1"
    >
      <div className="w-full">
        <h3 className="mb-4 text-lg max-md:mb-0 max-md:text-[13px]">
          {development.title}
        </h3>
